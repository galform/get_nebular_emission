...
'''TEST PLOT MEDIANS'''
def plot_medians(infile=r"output_data/emlines_SAGE.hdf5",plot2folder=r'./plots'):
    from get_nebular_emission.eml_plots import test_medians as testmed
    testmed(infile=infile,outplot=plot2folder, verbose=True)

'''TEST BPT DIAGRAM'''
def plot_bpt(infile=r"output_data/emlines_GALFORM_g23.hdf5",plot2folder=r'./plots'):
